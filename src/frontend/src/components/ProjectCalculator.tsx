  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="glass-panel p-8 rounded-3xl border border-neon-blue/30 shadow-glow">
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            {featureOptions.map((option) => (
              <div
                key={option.key}
                className="flex items-start space-x-3 p-4 rounded-xl glass-panel border border-electric-purple/20 hover:border-electric-purple/50 transition-all duration-300"
              >
                <Checkbox
                  id={option.key}
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-neon-blue mt-1">{option.cost}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          {error && (
            <div className="mt-6 p-4 rounded-xl bg-destructive/10 border border-destructive/50">
          ...
          {estimate !== null && !error && (
            <div className="mt-8 text-center">
              <div className="glass-panel p-8 rounded-2xl border border-neon-blue shadow-glow-lg">
                <p className="text-lg text-foreground/70 mb-2">Estimated Project Cost</p>
